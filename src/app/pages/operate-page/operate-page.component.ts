...
export class OperatePageComponent implements OnInit, OnDestroy {
  fakeCells: GuiFakeCell[] = [];
    allTransmitting: boolean = false;
    showMe: boolean = false;
    txAllText = "Transmit All";
    ...
    _messageRecieved(message: Message){
        if(message.type === 'auto-config-lies'){
            this.showMe = true;
        }
...
//         console.log("hi");
//         this.scanService.subscribeToAutoRecs().subscribe(fakeCells => {
//             if(this.numBTS >= fakeCells.length){
//                 this.fakeCells = fakeCells;
//             }
//         });
//     }
//     transmitAllToggled(){
